            ...
            if col in metadata_dict:
                ...
                if label_encoders and col in label_encoders:
                    ...
                    simple_mapping = {
                        ...
                        'left': 0, 'right': 1,
                        # 🔹 UPDATED: visibility mapping includes "slight"
    ...
    with tab1:
        ...
        with col2:
            ...
            with st.form("metadata_form"):
                ...
                with col_b:
                    ...
                    # 🔹 UPDATED: includes "slight"
                    gap_visibility = st.selectbox(
                        "Gap Visibility",
                        ["visible", "slight", "not_visible", "unknown"]
                    )
        ...
        if uploaded_file and submit_button:
            with st.spinner("Analyzing..."):
                ...
                # Use primary_diagnosis to populate fracture_type metadata
                ...
                if meta_features is not None:
                    ...
                    # Show primary diagnosis (if provided)
                    with col4_m:
